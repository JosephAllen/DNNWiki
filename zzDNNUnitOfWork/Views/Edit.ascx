<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Edit.ascx.cs" Inherits="DotNetNuke.Modules.DNNUnitOfWork.Views.Edit" %>
...
<asp:LinkButton ID="btnSubmit" OnClick="btnSubmit_Click" runat="server" resourcekey="btnSubmit" CssClass="dnnPrimaryAction" />
<asp:LinkButton ID="btnCancel" OnClick="btnCancel_Click" runat="server" resourcekey="btnCancel" CssClass="dnnSecondaryAction" />
