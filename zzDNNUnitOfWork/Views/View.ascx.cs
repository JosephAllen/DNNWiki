...
using DotNetNuke.Modules.DNNUnitOfWork.BusinessObjects;
using DotNetNuke.Modules.DNNUnitOfWork.BusinessObjects.Models;
...
namespace DotNetNuke.Modules.DNNUnitOfWork.Views
{
    ...
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class View : DNNUnitOfWorkModuleBase, IActionable
    {
