...
{
    /// -----------------------------------------------------------------------------
    /// <summary> The Controller class for DNNWikiTestVersion
    ///
    ...
    public class FeatureController //: IPortable, ISearchable, IUpgradeable
    {
        ...
        // foreach (DNNWikiTestVersionInfo objDNNWikiTestVersion in colDNNWikiTestVersions) { strXML
        // += "<DNNWikiTestVersion>"; strXML += "<content>" +
        // DotNetNuke.Common.Utilities.XmlUtils.XMLEncode(objDNNWikiTestVersion.Content) +
        // "</content>"; strXML += "</DNNWikiTestVersion>"; } strXML += "</DNNWikiTestVersions>";
        //}
