...
namespace DotNetNuke.Modules.DNNWikiUnitOfWork.Views
{
    /// -----------------------------------------------------------------------------
    /// <summary> The Settings class manages Module Settings
    ///
    ...
    ///
    /// If you happen to save both TabModuleSettings and ModuleSettings, TabModuleSettings overrides
    /// ModuleSettings.
    ///
    /// Below we have some examples of how to access these settings but you will need to uncomment
    /// to use.
    ///
    /// Because the control inherits from DNNWikiTestVersionSettingsBase you have access to any
    /// custom properties defined there, as well as properties from DNN such as PortalId, ModuleId,
    /// TabId, UserId and many more. </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : DNNWikiUnitOfWorkModuleSettingsBase
    {
        ...
        public override void LoadSettings()
        {
            ...
            // if (Settings.Contains("Setting2")) txtSetting2.Text =
            // Settings["Setting2"].ToString();
        ...
        public override void UpdateSettings()
        {
            ...
            // //the following are two sample Module Settings, using the text boxes that are
            // commented out in the ASCX file. //module settings
