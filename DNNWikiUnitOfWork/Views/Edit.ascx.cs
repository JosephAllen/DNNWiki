...
namespace DotNetNuke.Modules.DNNWikiUnitOfWork.Views
{
    ...
    /// manifest (.dnn) file.
    ///
    /// Because the control inherits from DNNWikiTestVersionModuleBase you have access to any custom
    /// properties defined there, as well as properties from DNN such as PortalId, ModuleId, TabId,
    /// UserId and many more.
    ///
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Edit : DNNWikiUnitOfWorkModuleBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // //check if we have an ID passed in via a querystring parameter, if so, load that item
            // to edit. //ItemId is defined in the ItemModuleBase.cs file if (ItemId > 0) { var tc =
            // new ItemController();
